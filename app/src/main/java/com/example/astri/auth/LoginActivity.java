package com.example.astri.auth;
...
import com.example.astri.DashboardActivity;
import com.example.astri.R;
import com.example.astri.data.Session;
import com.example.astri.model.LoginResponse;
import com.example.astri.utils.DialogUtils;
...
import static com.example.astri.data.Constans.LOGIN;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        AndroidNetworking.post(LOGIN).addBodyParameter("userid", email.getText().toString())
