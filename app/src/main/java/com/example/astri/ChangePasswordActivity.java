...
import com.example.astri.data.Constans;
import com.example.astri.data.Session;
import com.example.astri.model.RegisterResponse;
        ...
        changeProfil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(name.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(ChangePasswordActivity.this, "passwordbaru harus diisi", Toast.LENGTH_SHORT).show();
                }
                else {
                    updateUser();
                }
